...
function TheoryListContent() {
  return (
    <main className="flex-1 flex flex-col px-4 py-8 gap-6 max-w-4xl mx-auto w-full">
      <div className="animate-fade-in-up">
        <Link href="/dashboard" className="text-muted text-sm w-fit">
          ← К сценариям
        </Link>
        <h1 className="font-display text-2xl lg:text-3xl font-extrabold mt-2">Теория переговоров</h1>
