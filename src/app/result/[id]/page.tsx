    ...
    <main className="flex-1 px-4 py-8 max-w-6xl mx-auto w-full">
      <div className="flex items-center gap-4 animate-fade-in-up mb-6">
        ...
        <div>
          ...
          <h1 className="font-display text-2xl lg:text-3xl font-extrabold">Итоги переговоров</h1>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-[1fr_20rem] gap-6 items-start">
        ...
        <div className="flex flex-col gap-6 lg:sticky lg:top-8">
          <div className="rounded-2xl bg-gradient-to-br from-accent to-accent-dark text-white p-6 flex items-center justify-between shadow-xl shadow-accent/25 animate-scale-in lg:flex-col lg:items-start lg:gap-4">
            <div>
